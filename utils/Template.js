                                      ...
                                      <div class="text-element paragraph">
                                        <div style="color: rgb(51, 51, 51); font-family: Arial, sans-serif; font-size: 18px; line-height: 125%; font-weight: 400; text-align: left;">
                                          ...
                                          <p style="color: rgb(51, 51, 51); font-family: Arial, sans-serif; font-size: 19px; line-height: 125%; font-weight: 400; text-align: center;">
                                           Please visit this link ${link} to reset password
                                          </p>
    
                                          <p style="color: rgb(51, 51, 51); font-family: Arial, sans-serif; font-size: 19px; line-height: 125%; font-weight: 700; text-align: center; margin-top: 24px">This Email is sent from lets Fix &#10084;
                                          </p>
                                        </div>
                                      </div>
                                    </div>
